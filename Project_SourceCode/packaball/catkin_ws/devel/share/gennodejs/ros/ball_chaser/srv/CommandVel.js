...
class CommandVelRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CommandVelRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CommandVelRequest
    let len;
    let data = new CommandVelRequest(null);
  ...
  static datatype() {
    ...
    return 'ball_chaser/CommandVelRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandVelRequest(null);
...
class CommandVelResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CommandVelResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CommandVelResponse
    let len;
    let data = new CommandVelResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ball_chaser/CommandVelResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandVelResponse(null);
...
module.exports = {
  Request: CommandVelRequest,
  Response: CommandVelResponse,
  md5sum() { return 'c8652349d2a34a90a09475339e2a93d9'; },
  datatype() { return 'ball_chaser/CommandVel'; }
};
